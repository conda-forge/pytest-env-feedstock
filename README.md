...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-env-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-env-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install pytest-env
```
...
It is possible to list all of the versions of `pytest-env` available on your platform:
...
```
pixi search pytest-env --channel conda-forge
```
